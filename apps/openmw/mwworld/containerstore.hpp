...
namespace MWWorld
{
    ...
    class ContainerStore
    {
        ...
        private:
            ...
            MWWorld::CellRefList<ESM::Tool<int>>         lockpicks;
        ...
        : public std::iterator<std::forward_iterator_tag, Ptr, std::ptrdiff_t, Ptr *, Ptr&>
    {
            ...
            MWWorld::CellRefList<ESM::Tool<int>>::List::iterator mLockpick;
        ...
        private:
            ...
            ContainerStoreIterator (ContainerStore *container, MWWorld::CellRefList<ESM::Tool<int>>::List::iterator);
